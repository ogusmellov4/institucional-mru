...
get_header(); ?>
    ...
    <div class="principal-banner">
        ...
        if ($galeria_imagens):
            ...
            $imagem_contato = $galeria_imagens[5];
            ?>
    ...
    <section id="apresentacao" class="flex w-100 gap-xl space-between">
        <div class="w-100">
            <img class="w-100 h-100 obj-fit-cover" src="<?php echo esc_url($imagem_principal['url']); ?>" alt="<?php echo esc_attr($imagem_principal['alt']); ?>">
                ...
                <div class="flex-col gap-md w-100">
                    <div class="flex full-center gap-lg">
                        <h3 class="fw-light text-secondary-gray text-nowrap fs-sm">TERRENOS</h3>
                        <div class="min-line"></div>
                    </div>
                    <div class="flex full-center space-between">
                        <div class="flex-col">
                            <h1 class="ft-uppercase fw-semibold fs-xl text-primary-black">Altos do Cerrito</h1>
                            <div class="flex space-between w-100">
                                <p class="fs-sm ft-uppercase">Lançamento</p>
                                <p class="fs-sm ft-uppercase">Em construção</p>
                            </div>
                        </div>
                        <a href="#formularioInteresse">
                            <button class="empreendimento-btn">Solicitar Oraçmento</button>
                        </a>
                    </div>
                    <?php
                        ...
                        if ($informacoes_gerais):
                            ...
                            if ($tipo_do_empreendimento === 'Residencial'):
                                ...
                                <div class="flex-col gap-xs">
                                    ...
                                    <p class="fs-sm"><?php echo esc_html($dormitorios ? $dormitorios : 'Indisponível'); ?></p>
                                </div>
                                <div class="flex-col gap-xs">
                                    <h2 class="ft-uppercase fs-sm">Garagem</h2>
                                    <p class="fs-sm"><?php echo esc_html($garagens_por_imovel ? $garagens_por_imovel : 'Indisponível'); ?></p>
                                </div>
                                <?php
                            endif;
            ...
            <section id="galeria" class="flex-col gap-xl w-100">
                <div class="flex full-center gap-lg">
                    <h3 class="fw-light text-secondary-gray text-nowrap fs-sm">ALTOS DO CERRITO / GALERIA</h3>
                    <div class="min-line"></div>
                </div>
                <div class="grid cols-12 gap-sm">
                    ...
                    if ($galeria):
                        // Supondo que a galeria terá no mínimo 8 imagens para preencher o layout
                        // Certifique-se de adaptar o código se a quantidade de imagens for diferente
                        ?>
                        <div class="col-set-1">
            ...
            <section id="progresso" class="flex-col w-100 gap-xl space-between">
                <div class="flex full-center gap-lg">
                    <div class="min-line"></div>
                    <h3 id="progresso-planta" class="fw-light text-secondary-gray text-nowrap fs-sm">ALTOS DO CERRITO / PROGRESSO & PLANTA BAIXA</h3>
                </div>
    ...
    <div class="flex-col gap-lg w-100">
            ...
            while (have_rows('planta_baixa')): the_row();
                ...
                <div class="planta-item wrap flex gap-md p-md w-100">
                    ...
                    <div class="flex-col space-around gap-sm w-100">
                        ...
                        <p>Área privativa: <?php echo esc_html($area_privativa); ?>m²</p> <!-- Aqui você pode ajustar para exibir a área correta, se disponível. -->
                    </div>
                </div>
                <?php
            endwhile;
        ...
        ?>
            ...
            <section id="infraestrutura" class="flex-col w-100 gap-xl space-between">
                <div class="flex full-center gap-lg">
                    <h3 class="fw-light text-secondary-gray text-nowrap fs-sm">ALTOS DO CERRITO / INFRAESTRUTURA</h3>
                    <div class="min-line"></div>
                </div>
                <div class="flex wrap gap-xl full-center">
                    <?php
            ...
            <section id="localizacao" class="flex-col w-100 gap-xl space-between">
                <div class="flex full-center gap-lg">
                    <div class="min-line"></div>
                    <h3 class="fw-light text-secondary-gray text-nowrap fs-sm">ALTOS DO CERRITO / LOCALIZAÇÃO</h3>
                    <div class="min-line"></div>
                </div>
            ...
            <section id="contato" class="flex-col w-100 gap-xl space-between">
                <div class="flex w-100 full-center gap-lg">
                    <h3 id="contato-titulo" class="fw-light text-secondary-gray text-nowrap fs-sm">ALTOS DO CERRITO / CONTATO</h3>
                    <div class="min-line"></div>
                </div>
                <div id="contatoInfo" class="flex w-100 gap-2xl">
                    <div class="flex-col gap-xl">
                        ...
                        <form action="" method="post" class="flex-col gap-lg" id="formularioInteresse">
                            <?php wp_nonce_field('enviar_interesse_action', 'enviar_interesse_nonce'); ?>
                            ...
                            <div class="input-group">
                                ...
                                <select class="basic-input" id="interesse_desejo" name="interesse_desejo">
                                    <option value="interesse_residencial" id="" name="">Acima de R$1.500.00</option>
                    ...
                    <div class="w-100">
                        <img class="w-100 h-100 obj-fit-cover" src="<?php echo esc_url($imagem_contato['url']); ?>" alt="<?php echo esc_attr($imagem_principal['alt']); ?>">
                    </div>
                </div>
            </section>
        </main>
